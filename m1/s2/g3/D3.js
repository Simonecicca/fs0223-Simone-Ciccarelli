...
// let z = 5;
// let y = 7;
// if(x > y) console.log(`Il valore maggiore è ${x}`);
// else console.log(`Il valore maggiore è ${y}`);
...
// if (x==8 || y==8 || x+y==8 || x-y==8) console.log("Ok!");
...
// let totalShoppingCart = Number(prompt("Inserisci il totale che devi pagare"));
// if(totalShoppingCart>50) console.log(`Spedizione gratuita più lo sconto del 20% per il black Friday, al posto di ${totalShoppingCart} euro, l'ammontare è di ${totalShoppingCart*0.8}`)
// else console.log(`Il tot è di ${(totalShoppingCart+10)*0.8} euro. Prezzo prima dello sconto: ${totalShoppingCart+10}`);
...
// else console.log("Il numero non è dispari.");
